...
<!--[if gt IE 10]><!--> <html class="version10"><!--<![endif]-->
    <head>
		...
		<meta name="Keywords" lang="en-us" content="jarl helin, online portfolio, musician, graphic and web design, orlando, florida, for hire, interactive, flash, cinema 4d, premium reseller apple, Cross browser, compatible"/>
		<meta name="reply-to" content="jarl@pellenetdesign.com"/>
		<meta name="category" content="Internet"/>
		<meta name="robots" content="index, follow"/>
		<meta name="distribution" content="global"/>
		<meta name="description" lang="en" content="The home of Jarl 'Pelle' Helin, a swede with roots in France. Jarl has been staying in in Orlando FL for two years, but went back to Mauves, France to continue his business in France. Jarl is available for contract and would gladly read from you.."/>
		<meta name="revisit-after" content="30 days"/>
		<meta name="author" lang="en" content="Jarl Pelle Helin"/>
		<meta name="copyright" content="PellenetDesign 2013"/>
		<meta name="generator" content="Illustrator, Photoshop, InDesign, Dreamweaver, Bridge, Flash, After Effects, Cinema 4D, Cubase, Native Instruments, Premier Pro, Php, SQL, jQuery, Ajax, Actionscript 2, Actionscript 3, WAMP Apache, IE TESTER, Internet Explorer 8, Safari 3.1+, Opera 10+, Firefox 3+, Chrome, Windows xp Pro, Windows 7 Pro, OSX Lion"/>
       ...
       <!-- media-queries.js (fallback) -->
		...
		<link rel="stylesheet" type="text/css" href="css/bootstrap.css"  class="cssfx"/>
...
<div class="container-fluid">
    <aside class="row-fluid hidden-phone topbar">
			<ul role="complementary" class="unstyled span2 row-fluid">
        ...
        <nav role="complementary" class="span4 icons"><!--Social buttons in Desktop Mode-->
    ...
    <header role="banner" class="row-fluid">
        <div role="img" class="span1">
			<a href="#" title="Logo Home">
				...
				<img src="img/icons/logoPhone.png" class="visible-phone" alt="Logotype Phone">
			</a>
        </div>
            ...
            <div class="row-fluid">  
                ...
                <ul class="nav connect">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="complementaire" aria-labelledby="dLabel">
                            <li role="application">
                                <a href="#">
    ...
    <section id="main" role="main">
			...
			<div id="mainCarousel" class="span8 mainCarousel slide ttTop">
                ...
                <div class="carousel-inner">
                        ...
                        <div class="carousel-caption-center-left">
                            <div class="inner-caption">
                                ...
                                <p>I am a graphic webdesigner solving problems for clients who doesn't want to or just doesn't have the time to..</p>
                                 <p class="hire-me"><a href="#" title="Check out my resume"><img src="img/icons/Available-for-hire.png"></a></p>
                                <a class="icons pull-right" href="#" title="Read More">&#xf055;</a>
                            </div>
                        </div>
                         <div class="carousel-caption-center-right">
                            <div class="inner-caption">
                               <a href="#"> <img src="img/photos/misc/profile.png"></a>
                            </div>
                        </div>
                    </div><!--end item-->
                    <div class="item">
                    ...
                    <div class=" newsletter-right input-prepend input-append">
                       <button class="btn" type="button"><div class="icons">@</div></button>
        ...
        <article class="row-fluid">
        	...
        	<div id="socialFeed" class="span4 tabbable">
        		<ul class="nav nav-tabs nav-tab-coloring" id="socialFeedTab">
                    ...
                    <li><a href="#email" data-toggle="tab">Message</a></li>
                </ul>
                <div class="tab-content ttTop">
                    ...
                    <div class="tab-pane" id="email">
                            ...
                            <fieldset class="span9 offset1">
                                ...
                                <div class="row-fluid">
                                    <label class="span6"><button class="btn"><div class="icon-question-sign"></div> Captcha</button></label>
        ...
        <div class="row-fluid hidden-phone ttTop"><!--desktop mode >=1024-->
            <aside class="span6 newsFeedBook"><!--news feed a cool book to read-->
           		<div class="row-fluid book"><!--book news wrap-->
                    <div class="span12">
                        <h3><div class="icon-exclamation-sign"></div> <a href="#" title="Page Read This Book">Read &amp; boost your ego</a></h3>
                        <div class="row-fluid ttTop">
                            ...
                            <div class="span9 offset1">
                                ...
                                <p>Augue eget mattis condimentum, dui mauris congue augue, pellentesque egestas enim neque molestie metus. </p>
                                 <div class="row-fluid">
                                    <div class="span6">
                                        <p><div class="icon-link"></div> <a href="#" title="Read posts by tag">tag</a> <a href="#" title="Read posts by tag">tags</a> <a href="#" title="Read posts by tag">tagged</a></p>
                                    </div>
                ...
                <div class="row-fluid book"><!--book news wrap-->
                    <div class="span12">
                        <h3><div class="icon-exclamation-sign"></div> <a href="#" title="Page Read This Book">Yes, Design is actually work too</a></h3>
                        <div class="row-fluid">
            ...
            <aside class="span3">
            	<h3><div class="icon-lightbulb"></div><a href="#" title="Page Blog"> Information</a></h3>
                <nav>
                    <table class="table table-hover table-bordered table-striped pull-right blogroll ">
                    <tr>
                    <td><a title="Title" href="http://alistapart.com/">A list Apart</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                    <tr>
                    <td><a title="Title" href="http://css-tricks.com/">CSS Tricks</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                     <tr>
                    <td><a title="Title" href="http://bootstraphero.com/">Bootstraphero</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                    <tr>
                    <td><a title="Title" href="http://www.webbyawards.com/">The Webby Awards</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                     <tr>
                    <td><a title="Title" href="http://www.bestwebdesignaward.com/">Best Design Award</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                    <tr>
                    <td><a title="Title" href="http://twitter.github.com/bootstrap/">The Twitter Bootstrap</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                    <tr>
                    <td><a title="Title" href="http://designtaxi.com/">Design Taxi</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                    </table> 
                </td>
            </aside>
            <aside class="span3">
            	<h3><div class="icon-lightbulb"></div><a href="#" title="Page Blog"> Inspiration</a></h3>
                <nav>
                     <table class="table table-hover table-bordered table-striped pull-right blogroll">
                    <tr>
                    <td><a title="Title" href="http://cssline.com/">CSS Line</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                    <tr>
                    <td><a title="Title" href="http://www.thefwa.com/">The FWA</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                     <tr>
                    <td><a title="Title" href="http://www.cssawards.net/">CSS Awards</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                    <tr>
                    <td><a title="Title" href="http://www.thebestdesigns.com/">The best Designs</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                     <tr>
                    <td><a title="Title" href="http://www.bestwebdesignaward.com/">Best Design Award</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                    <tr>
                    <td><a title="Title" href="http://www.cssdesignawards.com/">CSS Design Awards</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                    <tr>
                    <td><a title="Title" href="http://www.awwwards.com/">AwwwARDS</a></td><td><a href="#" title="tag">tag</a> <a href="#" title="tags">tags</a> <a href="#" title="tagged">tagged</a></div></td>
                    </tr>
                    </table>
                </nav>
            </aside>
    	...
    	<div class="row-fluid">
                <div class="span6">
                    <form class="form-horizontal">
						<fieldset>
                            <legend><div class="icon-circle-arrow-right"></div> Send me a message</legend>
                ...
                <div class="row-fluid">
                    <nav class="span6">
                    <legend><div class="icon-phone"></div> Call me</legend>
                    ...
                    <nav class="span6">
                        <legend><div class="icon-bullhorn"></div> Holler!</legend>
                        <div id="socialMeWrap">
